                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-gray-300 mb-6 max-w-md">
                            Votre plateforme de confiance pour l'achat et la vente de véhicules d'occasion et neufs. 
                            Trouvez la voiture de vos rêves ou vendez votre véhicule en toute simplicité.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href={route('cars.index')} className="text-gray-300 hover:text-white transition-colors">
                                    Catalogue
                                </Link>
                            </li>
                            <li>
                                <Link href={route('cars.create')} className="text-gray-300 hover:text-white transition-colors">
                                    Vendre un véhicule
                                </Link>
                            </li>
                            <li>
